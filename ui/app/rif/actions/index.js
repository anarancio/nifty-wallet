...
function getChannelsGroupedByNetwork () {
  return (dispatch) => {
    return new Promise((resolve, reject) => {
      // TODO Rodrigo
      // Delete this mocks when ui classes are assigned
      resolve({'0xbe17703153A321e9b9867fD90f194BdD605Cc243': [{'total_deposit': 0, 'reveal_timeout': 50, 'channel_identifier': 7, 'settle_timeout': 500, 'partner_address': '0x4881c38BB234bda9A71C3F3e738e57357d531D18', 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'balance': 0, 'state': 'opened', 'token_symbol': 'LUM', 'token_name': 'LuminoToken', 'sdk_status': 'CHANNEL_OPENED', 'offChainBalance': '0', 'receivedTokens': '0', 'sentTokens': '0', 'votes': {'open': {}, 'close': {}}}, {'channel_identifier': '6', 'partner_address': '0xcF47Af9603215D3a6Dc1Aa08B5d5CD46b61291B3', 'settle_timeout': '500', 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '0', 'state': 'opened', 'total_deposit': '0', 'reveal_timeout': '50', 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '0', 'receivedTokens': '0', 'sentTokens': '0', 'sdk_status': 'CHANNEL_OPENED'}, {'channel_identifier': 5, 'partner_address': '0x46cB37FBf87732846751b79A9aAAB076108d630C', 'settle_timeout': 500, 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '1000000000000000000', 'state': 'closed', 'total_deposit': '1000000000000000000', 'reveal_timeout': 50, 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '1000000000000000000', 'receivedTokens': '0', 'sentTokens': '0', 'sdk_status': 'CHANNEL_WAITING_FOR_CLOSE'}, {'channel_identifier': 8, 'partner_address': '0x46cB37FBf87732846751b79A9aAAB076108d630C', 'settle_timeout': 500, 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '1000000000000000000', 'state': 'opened', 'total_deposit': '1000000000000000000', 'reveal_timeout': 50, 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '900000000000000000', 'receivedTokens': '0', 'sentTokens': '100000000000000000', 'sdk_status': 'CHANNEL_OPENED'}]});
...
function getUserChannelsInNetwork (tokenAddress) {
  return (dispatch) => new Promise((resolve, reject) => {
    // TODO Rodrigo
    // Delete this mocks when ui classes are assigned
    resolve([{'total_deposit': 1000000000000000000, 'reveal_timeout': 50, 'channel_identifier': 7, 'settle_timeout': 500, 'partner_address': '0x4881c38BB234bda9A71C3F3e738e57357d531D18', 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'balance': 0, 'state': 'opened', 'token_symbol': 'LUM', 'token_name': 'LuminoToken', 'sdk_status': 'CHANNEL_OPENED', 'offChainBalance': '0', 'receivedTokens': '0', 'sentTokens': '0', 'votes': {'open': {}, 'close': {}}}, {'channel_identifier': '6', 'partner_address': '0xcF47Af9603215D3a6Dc1Aa08B5d5CD46b61291B3', 'settle_timeout': '500', 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '0', 'state': 'opened', 'total_deposit': '0', 'reveal_timeout': '50', 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '0', 'receivedTokens': '0', 'sentTokens': '0', 'sdk_status': 'CHANNEL_OPENED'}, {'channel_identifier': 5, 'partner_address': '0x46cB37FBf87732846751b79A9aAAB076108d630C', 'settle_timeout': 500, 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '1000000000000000000', 'state': 'closed', 'total_deposit': '1000000000000000000', 'reveal_timeout': 50, 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '1000000000000000000', 'receivedTokens': '0', 'sentTokens': '0', 'sdk_status': 'CHANNEL_WAITING_FOR_CLOSE'}, {'channel_identifier': 8, 'partner_address': '0x46cB37FBf87732846751b79A9aAAB076108d630C', 'settle_timeout': 500, 'token_address': '0xe1b8eC5381FCA746E7Fe6d60CEb898FEdB44462A', 'token_name': 'LuminoToken', 'token_symbol': 'LUM', 'balance': '1000000000000000000', 'state': 'opened', 'total_deposit': '1000000000000000000', 'reveal_timeout': 50, 'token_network_identifier': '0xbe17703153A321e9b9867fD90f194BdD605Cc243', 'votes': {'open': {'http://localhost:8082': true, 'http://localhost:8083': true}, 'close': {}}, 'offChainBalance': '900000000000000000', 'receivedTokens': '0', 'sentTokens': '100000000000000000', 'sdk_status': 'CHANNEL_OPENED'}]);
    background.rif.lumino.getChannels((error, channels) => {
      if (error) {
        dispatch(niftyActions.displayWarning(error));
        return reject(error);
